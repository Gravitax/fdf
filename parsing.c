...
/*   Updated: 2019/06/22 15:55:17 by maboye           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*check_file(t_fdf *data, char *file, int tmp)
{
	...
	if (file)
	{
		...
		data->start_x = (WIN_L / data->map_larg) / 3;
		data->start_y = (WIN_H / data->map_haut) / 3;
		// data->zoom_x = (WIN_L / data->map_larg) / 3;
		// data->zoom_y = (WIN_H / data->map_haut) / 3;
	}
	return (file);
}
